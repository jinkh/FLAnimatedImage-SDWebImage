...
//    self.imageView1.animatedImage = animatedImage1;
    [self.imageView1 sd_setImageWithURL:url1];
    ...
    [self.imageView2 sd_setImageWithURL:url2];
    ...
    [self.imageView3 sd_setImageWithURL:url3 placeholderImage:nil options:SDWebImageProgressiveDownload completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
    }];
    // ... that's it!
